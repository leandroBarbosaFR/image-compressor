...
//             className="flex items-center cursor-pointer justify-center gap-2 px-4 py-2 w-full sm:w-auto bg-white text-black rounded-md cursor-pointer hover:bg-white-700 transition"
//           >
    ...
    >
      ...
      >
        <Select
          ...
          onValueChange={(val: ImageFormat) => setSourceFormat(val)}
        >
          <SelectTrigger className="w-full sm:w-[150px] bg-muted border rounded-md px-3 py-3 hover:border-primary transition touch-manipulation">
            <SelectValue placeholder="From" />
          </SelectTrigger>
          <SelectContent className="bg-black/95 backdrop-blur-md text-white rounded-lg shadow-lg border border-white/10">
            {["jpeg", "png", "webp", "avif", "gif", "tiff", "bmp", "heic"].map(
      ...
      {compressedFiles.length > 0 && (
        <div className="flex flex-col gap-3 mt-6 mb-6 relative z-10 w-full max-w-lg px-4">
          <button
            onClick={handleClearAll}
            className="flex items-center justify-center gap-2 px-4 py-3 w-full bg-white text-black rounded-md hover:bg-gray-100 transition touch-manipulation"
          >
            <PiTrash className="text-lg" />
            Clear All
          </button>
          ...
          {compressedFiles.length > 1 && (
            <button
              onClick={handleDownloadAll}
              className="flex items-center justify-center gap-2 px-4 py-3 w-full bg-primary text-white rounded-md hover:bg-primary/80 transition touch-manipulation"
            >
              <PiArchive className="text-lg" />
              Download All as ZIP
            </button>
